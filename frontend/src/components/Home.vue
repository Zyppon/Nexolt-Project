<template>
        ...
        <div class="container is-fluid">
          ...
          <div :class="['navbar-menu', {'is-active': isActive}]">
            <div class="navbar-start">
              <router-link class="navbar-item" to="/login">About</router-link>
              <router-link class="navbar-item" href="/register">Company</router-link>
  ...
  export default {
    ...
    data() {
      return {
        isActive: false,  // Control burger menu active state
      };
    },
    methods: {
      toggleMenu() {
        this.isActive = !this.isActive;  // Toggle the state when burger is clicked
      }
    }
  };
  </script>
